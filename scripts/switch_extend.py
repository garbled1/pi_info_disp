...
while True:
    ...
    input_state_reload = GPIO.input(21)
    ...
    if input_state_forward == False:
        ...
        time.sleep(0.5)
    if input_state_reload == False:
        print('Reload Button Pressed')
        device.emit_click(uinput.KEY_F5)
        time.sleep(0.5)

    if input_state_reload == False and input_state_back == False and input_state_forward == False:
    ...
    #     	input_state_multi = GPIO.input(22)
